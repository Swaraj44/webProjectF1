...
<div class="article">
    ...
    $user_tem_email = Auth::user()->email;


    
    <form action="{{ route('update', $userInfo->id) }}" method="POST">
        @csrf
        ...
        <input type="text" name="user_name" value="{{ $userInfo->user_name }}" required>
        
        <label for="email">Email:</label>
        <input type="email" name="email" value="{{ $userInfo->email }}" required>
        
        <label for="role">Role:</label>
        <input type="text" name="role" value="{{ $userInfo->role }}" required>
